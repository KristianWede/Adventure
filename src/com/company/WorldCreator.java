...
public class WorldCreator {
  ...
  public void createWorldMap() {
    ...
    //Initializing items.
    Item key = new Item("Old Key", "A very old-looking key. Wonder where it belongs", 0, 3,true);
    Item bucketOfLava = new Item("Bucket of Lava", "This probably breaks a few laws of physics...", 0, 4, true);
    Item paint = new Item("Paint", "N/A", 0, 5, true);
    Item paper = new Item("Paper", "N/A", 0, 3, true);
    Item golfClub = new Item("Golf Club", "N/A", 0, 3, true);
